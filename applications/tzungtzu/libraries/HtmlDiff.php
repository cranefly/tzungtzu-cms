<?php
	...
	class HtmlDiff {
		...
		public function __construct($params = NULL ) {
            // $oldText, $newText, $encoding = 'UTF-8'
            if ($params !== NULL){
                $this->oldText = $this->purifyHtml( trim( $params['oldText'] ) );
                $this->newText = $this->purifyHtml( trim( $params['newText'] ) );
                $this->encoding = isset($params['encoding']) ? $params['encoding'] : 'UTF-8';
            }
        ...
        public function setOldHtml($oldHtml) {
            $this->oldText = $oldHtml;
		}

		public function setNewHtml($newHtml) {
            $this->newText = $newHtml;
		}
