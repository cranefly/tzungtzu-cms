...
class Vcode{
	...
	public function __construct($width=100,$height=30,$codeNum=4){
        ...
        $this->fontFace = __DIR__ . $this->fontFace;
	}
	...
	private function outputText(){
		...
		for($i=0;$i<$this->codeNum;$i++){
			...
			if($this->fontFace){
				...
				imagettftext($this->image,$fontSize,mt_rand(-30, 30),$x,$y ,$fontColor, $this->fontFace,self::msubstr($this->code,$i));
			}else{
