<div id="form_add">
	<form action="<?php echo site_url($this->PagePath);?>" method="post" id="form_data">
		...
		<table class="table_lists editbox">
			...
			<tr>
				<td class="fr"><?php echo $langcu['form_gurl'] . $langco['colon']?></td>
            ...
            <tr>
                ...
                <td>
                    <input name="data[gimg]" id="upload_img_value" value="<?php echo $data['gimg']?>" type="hidden">
...
<div class="footer_fixed">
    <div class="box_1000">
		...
		<?php $tz->btn('E0501', 'javascript:;', $langcu['btn_save'], 'btn3 js_btn_save');?> 
		<?php $tz->btn('E05', site_url($this->PagePath), $langco['btn_back'], 'btn3');?> 
    </div>
</div>
