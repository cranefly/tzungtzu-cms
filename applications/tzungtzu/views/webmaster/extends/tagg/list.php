		...
		<table class="table_lists table_click">
			...
			<tbody>
				...
				<tr id="formli<?php echo $key;?>">
					...
					<td>
					<?php $tz->btn('E0501',  base_url($this->PagePath . '/edit?id=' . $value['id']), $langco['btn_edit'], 'btn');?>
                    <?php $tz->btn('E0502',  "javascript:del_one({$value['id']})", $langco['btn_delete'], 'btn');?> 
					</td>
				</tr>
				<?php }?>
			</tbody>
...
<div class="footer_fixed">
    <div class="box_1000">
        ...
        <?php $tz->btn('E0501', base_url($this->PagePath . '/add'), $langcu['btn_add'], 'btn3');?>  
        <?php $tz->btn('E0502', "javascript:del_data();", $langco['btn_deletes'], 'btn3');?> 
