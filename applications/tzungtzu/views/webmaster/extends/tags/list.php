		...
		<table class="table_lists table_click">
			<thead>
				<tr>
					...
					<th width="140" align="left"><?php echo $tz->set_sort(base_url($this->PagePath), 'id', 'ID');?></th>
					<th align="left"><?php echo $tz->set_sort(base_url($this->PagePath), 'tag', $langcu['form_tag']);?></th>
					<th align="left"><?php echo$langcu['form_tag_img'];?></th>
					<th width="120" align="left"><?php echo $langcu['form_tag_url'];?></th>
			...
			<tbody>
				...
				<tr id="formli<?php echo $key;?>">
					...
					<td><?php if (!empty($value['tagimg'])){?><img src="<?php echo $value['tagimg'];?>" style="width:20px;height: 20px;"/><?php }else{echo('--');}?></td>
					<td><?php echo $value['tagurl'];?></td>
					<td><?php echo $value['forder'];?></td>
					<td>
					<?php $tz->btn('E0601',  base_url($this->PagePath . '/edit?id=' . $value['id']), $langco['btn_edit'], 'btn');?>   
                    <?php $tz->btn('E0602',  "javascript:del({$value['id']})", $langco['btn_delete'], 'btn');?> 
					</td>
				</tr>
				<?php }?>
			</tbody>
...
<div class="footer_fixed">
    <div class="box_1000">
        ...
        <?php $tz->btn('E0601', base_url($this->PagePath . '/add'), $langcu['btn_add'], 'btn3');?>
        <?php $tz->btn('E0602', "javascript:del_data();", $langco['btn_deletes'], 'btn3');?> 
