	...
	<form action="<?php echo base_url($this->PagePath);?>" method="post" id="form_data">
		<table class="table_lists editbox">
			<tr>
				...
				<td><input type="text" name="data[mtitle]" class="comm_ipt" value=""></td>
			</tr>
			<tr>
				<td class="fr"><span class="fred">* </span><?php echo $langcu['form_mname'] . $langco['colon']?></td>
				<td><input type="text" name="data[mname]" class="comm_ipt" value=""> </td>
			</tr>
			<tr>
				...
				<td>
					<select name="data[cmid]" require="require">
						...
						<option value="<?php echo $m['id']?>"><?php echo $m['mtitle']?></option>
						<?php }?>
					</select>
				</td>
			</tr>
			<tr>
                ...
                <td><textarea name="data[attr_content]"></textarea></td>
			</tr>
		</table>
	</form>
</div>
