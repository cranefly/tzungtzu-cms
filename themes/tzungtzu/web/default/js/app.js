...
var App = function() {
	...
	var uiSearch = function() {
		jQuery( '.search' ).on( 'click', function () {
			if ( jQuery( '.search-btn' ).hasClass( 'ion-ios-search-strong' ) ) {
				jQuery( '.search-open' ).fadeIn( 500 );
				jQuery( '.search-btn' ).removeClass( 'ion-ios-search-strong' );
				jQuery( '.search-btn' ).addClass( 'ion-close' );
			} else {
				jQuery( '.search-open' ).fadeOut( 500 );
				jQuery( '.search-btn' ).addClass( 'ion-ios-search-strong' );
				jQuery( '.search-btn' ).removeClass( 'ion-close' );
			}
		});
	};
